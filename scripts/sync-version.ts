...
// Update src/bun/version.ts
const versionPath = join(root, "src/bun/version.ts");
const versionContent = `// Auto-generated by scripts/sync-version.ts — do not edit manually
